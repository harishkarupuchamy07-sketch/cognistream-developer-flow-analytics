...
PROJECT_DIR = "/Users/mdmuzammilkhan/development/cognistream-developer-flow-analytics"
...
with DAG(
    ...
    load_to_clickhouse = BashOperator(
        ...
        bash_command=f"cd {PROJECT_DIR} && python3 load_events.py",
    )
    ...
    validate_data >> load_to_clickhouse